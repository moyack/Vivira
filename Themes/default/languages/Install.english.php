...
$txt['congratulations_help'] = 'If at any time you need support, or PortaMx Forum fails to work properly, please remember that <a href="https://www.portamx.com" target="_blank" rel="noopener">help is available</a> if you need it.';
...
$txt['db_settings_innodb'] = 'Use INNODB Tables if possible';
$txt['db_settings_innodb_info'] = 'INNODB tables tend to be slightly faster than MyISAM tables.<br>Disadvantage: You can not create a <strong>Full-Text Index</strong>. In this case you have to use a <strong>Custom Index</strong>.';
...
$txt['upgrade_ready_proceed'] = 'Thank you for choosing to upgrade to %1$s. All files appear to be in place, and we\'re ready to proceed.';
