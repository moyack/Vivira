...
$txt['permissionname_likes_like'] = 'Can like any post';
$txt['permissionhelp_likes_like'] = 'This permission allows an user to like any post. Users aren\'t allowed to like their own posts.';
...
$txt['permissionhelp_view_attachments'] = 'Attachments are files that are attached to posted messages. This feature can be enabled and configured in \'Attachments and avatars\'. Since attachments are not directly accessed, you can protect them from being downloaded by the <strong>download permission.</strong>';
...
$txt['permissionname_download_attach_image'] = 'Download image attachments';
$txt['permissionhelp_download_attach_image'] = 'Normally, attached images can not be downloaded, this can only show enlarged in the image viewer. If this option is enabled, attached images can be downloaded. The image can be be protected with a watermark.';
$txt['permissionname_download_attach_file'] = 'Download file attachments';
$txt['permissionhelp_download_attach_file'] = 'This will allow the users to download a attached file.';
