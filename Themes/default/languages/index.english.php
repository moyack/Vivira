...
$txt['agreement_disabled'] = '<strong>Registration agreement disabled !</strong>';

$txt['calendar_allday'] = 'All day';
$txt['cal_location'] = 'Location';
$txt['days_title'] = 'Days';
...
$txt['rltv_hour'] = 'an hour ago';
$txt['rltv_minute'] = 'a minute ago';
$txt['rltv_second'] = 'few seconds ago';

// converting template parts (signup/profile)
$txt['cust_loca'] = array(
	'field_name' => 'Location',
	'field_desc' => 'Geographic location.'
);
...
$txt['no_user_with_email'] = 'That username does not exist or there are no username associated with that email.';
...
$txt['mobile_subMenu_var'] = '<strong>Mobile Menu "%s"</strong>';
$txt['profile_submenu_title'] = '<strong>Mobile Menu "Profile"</strong>';
$txt['moderate_submenu_title'] = '<strong>Mobile Menu "Moderate"</strong>';
...
$txt['last_post_message'] = '<strong>Last post: </strong>%3$s <span class="postby">%2$s <strong>by</strong> %1$s</span>';
$txt['last_post_topic'] = '%1$s<br><strong>by</strong> %2$s';
$txt['post_by_member'] = '<strong>%1$s</strong> by <strong>%2$s</strong><br>';
$txt['boardindex_total_posts'] = 'Posts: %1$s, Topics: %2$s, Members: %3$s';
$txt['show'] = 'Show';
$txt['hide'] = 'Hide';
$txt['play_on_youtube'] = 'Click to watch the video on Youtube';

$txt['admin_login'] = 'Administration Login';
$txt['topic'] = 'Topic';
$txt['help'] = 'Help';
$txt['terms_and_rules'] = 'Privacy Policy Agreement';
...
$txt['watching_this_topic'] = 'You are watching this topic.';
$txt['notify'] = 'Notify';
...
$txt['last_edit_by'] = '<span class="lastedit"><strong>Last Edit</strong></span>: %1$s by %2$s';
$txt['last_edit_reason'] = '<span class="lastedit"><strong>Reason</strong></span>: %1$s';
$txt['notify_deactivate'] = 'Would you like to deactivate notification on this topic?';

$txt['recent_posts'] = 'Recent Posts';

$txt['location'] = 'Location';
$txt['no_location'] = '<strong>Not given</strong>';
...
$txt['welcome_guest'] = 'Welcome, <strong>%1$s</strong>. Please <a href="%3$s" onclick="%4$s" rel="nofollow"><strong>login</strong></a>.';
$txt['welcome_guest_register'] = 'Welcome to <strong>%2$s</strong>. Please <a href="%3$s" onclick="%4$s" rel="nofollow"><strong>login</strong></a> or <a href="%5$s" rel="nofollow"><strong>sign up</strong></a>.';
$txt['please_login'] = 'Please <a href="' . $scripturl . '?action=login" rel="nofollow"><strong>login</strong></a>.';
$txt['login_or_register'] = 'Please <a href="' . $scripturl . '?action=login" rel="nofollow"><strong>login</strong></a> or <a href="' . $scripturl . '?action=signup" rel="nofollow"><strong>signup</strong></a>.';
$txt['welcome_guest_activate'] = '<br>Did you miss your <a href="' . $scripturl . '?action=activate" rel="nofollow">activation email</a>?';
...
$txt['mark_as_read'] = 'Mark ALL as read';
...
$txt['recycled_topic'] = 'Recoverable Topic';
...
$txt['name_reserved'] = 'This name can not be used.';
...
$txt['code'] = '<strong>Code</strong>';
$txt['highlight_code'] = '<strong>Highlighted code</strong>';
...
$txt['agreement_missing'] = 'You are requiring new users to accept a registration agreement, however the file (agreement.*.php) doesn\'t exist.';

$txt['cache_writable'] = 'The cache directory is not writable - this will adversely affect the performance of your forum.';

$txt['page_created_full'] = 'Page created in %1$s seconds with %2$d queries.';
...
$txt['download_imageattach'] = 'Download image';
$txt['download_fileattach'] = 'Download file';
...
$txt['quick_mod_remove_all'] = 'Remove ALL Alerts';
...
$txt['unread_topics_visit_none'] = 'No unread posts found since your last visit. <a href="' . $scripturl . '?action=unread;all"><strong>Click here to try all unread posts</strong></a>.';
$txt['unread_topics_updated_none'] = 'No updated topics found since your last visit. <a href="' . $scripturl . '?action=unread;all"><strong>Click here to try all unread topics</strong></a>.';
...
$txt['help_popup'] = 'Help to the selected setting';
...
// Mobile Actions
$txt['mobile_action'] = '<strong>User actions</strong>';
$txt['mobile_moderation'] = '<strong>Moderation</strong>';
$txt['mobile_user_menu'] = '<strong>Mobile Main Menu</strong>';
$txt['mobile_admin_menu'] = '<strong>Mobile Admin Menu</strong>';
