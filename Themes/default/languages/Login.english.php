...
// GDPR (DSGVO)
$txt['gdpr_registration_agreement'] = 'General Data Protection Regulation (GDPR) - Privacy Policy Agreement';
$txt['gdpr_agreement_agree'] = 'I have read and agree to this Privacy Policy.';
$txt['gdpr_agreement_footer'] = '<br>Privacy Policy "'. $mbname .'"';
$txt['gdpr_agreement_updated'] = ', updated on {date}';

// Registration agreement page
$txt['registration_agreement'] = 'Privacy Policy Agreement';
$txt['agreement_agree'] = 'I accept the terms of this Policy.';
$txt['agreement_agree_coppa_above'] = 'I accept the terms of the Policy and I am at least %1$d years old.';
$txt['agreement_agree_coppa_below'] = 'I accept the terms of the Policy and I am younger than %1$d years old.';
...
$txt['setting_requireAgreement'] = 'Show and require agreement letter when registering';
...
$txt['registration_username_unavailable'] = 'The username is not available, too short (4 characters minimum), does not start/end with a letter, or contains invalid characters. Allowed characters: a-z, A-Z, 0-9, hyphen, underscore.';
