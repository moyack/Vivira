...
$txt['is_installed'] = ' <strong>[ Installed ]</strong>';
$txt['can_update'] = ' <strong>[ New version available ]</strong>';
...
$txt['theme_package'] = 'Theme packages';
...
$txt['package_install_options_ftp_why'] = 'Using the package manager\'s FTP functionality is the easiest way to avoid having to manually chmod the files writable through FTP yourself for the package manager to work. Here you can set the default values for some fields.';
