...
$txt['relative_time_date'] = 'Relative Date &amp; Time';
...
Caching will work best if you have PHP compiled with one of the above optimizers, or have memcache available. If you do not have any optimizer installed, PortaMx Forum will do Database caching or File based caching.';
$txt['detected_no_caching'] = '<strong class="alert">PortaMx Forum has not been able to detect a compatible accelerator on your server. Database caching or File based caching can be used instead.</strong>';
...
$txt['dbcache_cache'] = 'Database caching';
...
$txt['recaptcha_configure_desc'] = 'Use the reCAPTCHA Verification System.<br>Don\'t have a key for reCAPTCHA? <a href="https://www.google.com/recaptcha/admin">Get your reCAPTCHA key here! (You need a Google Account!)</a>.';
$txt['recaptcha_enabled'] = 'Use reCAPTCHA Verification System';
$txt['recaptcha_enable_desc'] = '(This replaces the visual verification with reCAPTCHA)';
$txt['recaptcha_theme'] = 'reCAPTCHA Theme';
$txt['recaptcha_theme_light'] = 'Light';
$txt['recaptcha_theme_dark'] = 'Dark';
$txt['recaptcha_public_key'] = 'Secret Key';
$txt['recaptcha_private_key'] = 'Website Key';
...
$txt['google_site_verification'] = 'Site Verification Meta-Tag';
$txt['google_site_verification_hlp'] = 'Your Google Search Console "Meta Tag" key for site verification.';
...
$txt['setting_view_warning_note'] = 'Determines who can see the warning level of users on the forum.';
...
$txt['signature_settings_warning'] = 'Note that settings are not applied to existing signatures by default.<br>
	<a href="' . $scripturl . '?action=admin;area=featuresettings;sa=sig;apply;%2$s=%1$s">Run the process now</a>';
...
$txt['add_language_error_no_response'] = 'The PortaMx site is not responding. Please try again later.';
...
$txt['languages_for_pspell'] = 'This is for <a href="http://www.php.net/function.pspell-new" target="_blank" rel="noopener" class="new_win">pSpell</a> - if installed';
...
$txt['languages_download_replaced'] = 'Replace';
...
$txt['languages_download_complete_desc'] = 'Language pack installed successfully. Please <a href="%1$s"><strong>click here to return</strong></a> to the languages page.';
