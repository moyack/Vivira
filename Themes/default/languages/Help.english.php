...
$helptxt['live_news'] = '<strong>Live announcements</strong><br>
	This box shows recently updated announcements from <a href="https://www.portamx.com/" target="_blank" rel="noopener" class="new_win">portamx.com</a>.
...
$helptxt['registrations'] = '<strong>Registration Management</strong><br>
	This page contains all the functions that could be necessary to manage new registrations on the forum. It contains up to three
...
$helptxt['userLanguage'] = 'Turning this setting on will allow users to select which language they use. It will not affect the default selection.';
$helptxt['errorLanguage'] = 'Select the language you will use for the logged Errors. It is the best choice to set this to the same language as the Admin use.';
...
$helptxt['todayMod'] = 'This will show "Today", "Yesterday" or a relative time instead of the date.<br><br>
		...
		<ul class="normallist">
			...
			<li><strong>Relative Date &amp; Time</strong><br>
			6 hours ago</li>
		</ul>';
...
$helptxt['pollMode'] = 'This selects whether polls are enabled or not. If polls are disabled, any existing polls will be hidden
		...
		&quot;Show Existing Polls as Topics&quot;.<br>To choose who can post polls, view polls, and similar, you
...
$helptxt['showCacheStatus'] = 'This will show the cache status (load, save as kilobytes and the time as milliseconds) for the current page at the bottom of the board if the cache enabled. <br>As Admin you have a <em>quick cache clear</em> link, simpe click on the word <strong>Cache</strong>.';
$helptxt['removeNestedQuotes'] = 'This will strip nested quotes from a post when citing the post in question via a quote link.';
$helptxt['max_image_width'] = 'This allows you to set a maximum size for posted pictures. Pictures smaller than the maximum will not be affected, bigger Pictures will be rescaled to the given value. This also determines how attached images are displayed when a thumbnail is clicked on.';
...
$helptxt['xmlnews_enable'] = 'Allows people to link to <a href="%1$s?action=.xml;sa=news" target="_blank" rel="noopener" class="new_win">Recent news</a>
...
$helptxt['loginHistoryDays'] = 'The number of days to keep login history under user profile tracking. The default is 7 days.';
...
$helptxt['queryless_urls'] = 'This changes the format of URLs a little so search engines will like them better. They will look like index.php/topic,1.0.html. This feature will ' . (isset($_SERVER['SERVER_SOFTWARE']) && (strpos($_SERVER['SERVER_SOFTWARE'], 'Apache') !== false || strpos($_SERVER['SERVER_SOFTWARE'], 'lighttpd') !== false) ? '' : 'not') . ' work on your server.<br><strong>This function will be deactivated, if the SEF mode enabled!</strong>';
$helptxt['minimize_files'] = 'This option will minimize all css and js files that are loaded everytime, everywhere for every user, reducing the requests calls to your server. New files are re-created everyday, if you want to re-create them just clean your forum\'s cache.<br /><strong>This option will be disabled automatically if cache disabled!</strong>';
...
$helptxt['avatars_on_boardIndex'] = 'Checking this setting will show the avatar of the user on the Board and Message index, they create the last post.';
...
$helptxt['requireAgreement'] = 'The agreement is shown when a user registers an account on this forum and has to be accepted before users can continue registration.';
...
$helptxt['latest_themes'] = 'This area shows a few of the latest and most popular themes from <a href="https://www.portamx.com/" target="_blank" rel="noopener" class="new_win">portamx.com</a>. It may not show up properly if your computer can\'t find <a href="https://www.portamx.com/" target="_blank" rel="noopener" class="new_win">portamx.com</a>, though.';
...
$helptxt['moderator_why_missing'] = 'Since moderation is done on a board-by-board basis, you have to make members moderators from the <a href="%1$s?action=admin;area=manageboards" target="_blank" rel="noopener" class="new_win">board management interface</a>.';
...
$helptxt['sef_enabled'] = '<center><strong>SEF - Seach Engine Friedly URL\'s</strong></center><hr><strong>The SEF engine requires mod_rewrite support.</strong><br><br>You need a <strong>.htacces</strong> file with follow content:<br>
<strong>RewriteEngine On<br>
RewriteCond %{REQUEST_FILENAME} !-f<br>
RewriteCond %{REQUEST_FILENAME} !-d<br>
RewriteRule ^(.*)$ index.php?sef=$1 [L,QSA]<br>
RewriteBase /subdirectory/</strong></br>
If your forum is <strong>not</strong> installed in a subdirectory, change this to <strong>RewriteBase /</strong><br><br>
If you cannot enable the SEF engine, please check if the <strong>.htaccess</strong> file exist and at the right place. <strong>Also check if the cache enabled!</strong>';
...
$helptxt['sef_spacechar'] = 'Character to be used for spaces in the url (typically _ or -).
	You should use <strong>-</strong> for better results. Leave this empty to remove any space.';
$helptxt['sef_stripchars'] = 'These characters will be stripped out of the url.<br><strong>If you change this, it may be that your forum not works properly.</strong>';
$helptxt['sef_actions'] = 'These are all of the actions of your forum and normally you do not have to modify this, because the SEF engine add not listed actions automatically (if enabled).
	...
	<strong>If you change this, it may be that your forum not works properly.</strong>';
