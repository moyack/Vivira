...
$txt['admin_main_welcome'] = 'This is your &quot;%1$s&quot;. From here, you can edit settings, maintain your forum, view logs, install packages, manage themes, and many other things.<br><br>If you have any trouble, please look at the &quot;Support &amp; Credits&quot; page. If the information there doesn\'t help you, feel free to <a href="https://www.portamx.com" target="_blank" rel="noopener" class="new_win">look to us for help</a> with the problem.<br>You may also find answers to your questions or problems by clicking the <span class="generic_icons help" title="%3$s"></span> symbols for more information on the related functions.';
...
$txt['admin_check_display_logging'] = 'Write these errors to the error log.';
...
$txt['attachment_not_asigned'] = '<strong>No assigned message</strong> - ';
...
$txt['agreement_not_writable'] = 'Warning - agreement.php is not writable, any changes you make will NOT be saved.';

$txt['version_check_desc'] = 'This shows you the versions of your installation\'s files versus those of the latest version. If any of these files are out of date, you should download and upgrade to the latest version at <a href="https://www.portamx.com/" target="_blank" rel="noopener" class="new_win">portamx.com</a>.';
...
$txt['viewmembers_day_ago'] = 'One day ago';
...
$txt['unknown'] = 'unknown';
$txt['security_wrong'] = '<strong>Administration login attempt!</strong>' . "\n" . 'Referer: %1$s' . "\n" . 'User agent: %2$s' . "\n" . 'IP: %3$s';
...
$txt['default_errloglang'] = 'Default language for error logging';

$txt['maintenance_subject'] = 'Subject for display';
$txt['maintenance_message'] = 'Message for display';

$txt['errlog_desc'] = 'The error log tracks every error encountered by your forum. 
	To delete any errors from the database, mark the checkbox, and click on <strong>Remove Selection</strong> at the bottom of the page.
	To empty the log completely, click on <strong>Clear Log</strong>.';
...
$txt['max_image_width'] = 'Max width of posted or attached images';
$txt['max_image_height'] = 'Max height of posted or attached images';
...
$txt['avatars_on_boardIndex'] = 'Show a small avatars on Board and Topic index';
...
$txt['sef_settings_description'] = 'This section allows you to edit the SEF (Serach Engine Friendly) URL Settings.<br>
	...
	A request like <strong>/index.php?topic=2.5</strong> is converted to <strong>/board-name/first-topic-subject/5/</strong> and a request like <strong>/index.php?action=search</strong> is converted to <strong>/search/</strong><br>
...
$txt['language_description'] = 'This section allows you to edit languages installed on your forum, download new ones from the PortaMx-Server. You may also edit language-related settings here.';
