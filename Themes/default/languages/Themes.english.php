...
$txt['themeadmin_admin_desc'] = 'This page allows you to change the default theme, reset members to all use a certain theme, and choose other settings related to theme selection. You are also able to install themes from here.<br>Don\'t forget to look at the theme settings for your themes for layout options.';
