...
$txt['spider_remove'] = 'Remove';
$txt['spider_block'] = 'Block Spider';
$txt['spider_is_blocked'] = 'Never (<strong>Blocked</strong>)';

$txt['spiders_change_selected'] = 'Change Selected Spider';
$txt['spider_change_selected_confirm'] = 'Are you sure you want to Block/Unblock or Remove these spiders?-n-On Remove and Block all associated statistics will also be deleted!';
