...
$txt['username_reserved'] = 'The username you tried to use contains the reserved name \'%0$s\'. Please try another username.';
...
$txt['registration_agreement_missing'] = 'The registration agreement file, agreement.php, is either missing or empty. Registrations have been disable until this is fixed';
...
$txt['error_username_unavailable'] = 'The username is not available, too short (4 characters minimum), does not start/end with a letter, or contains invalid characters. Allowed characters: a-z, A-Z, 0-9, hyphen, underscore.';
$txt['error_no_name'] = 'No name was provided.';
$txt['error_username_reserved'] = 'The submitted name is protected and can not be used.';
$txt['invalid_characters_username'] = 'The username contains invalid characters.';
...
// recapcha messages
$txt['error_recapcha_post_preview'] = 'Please complete the reCAPTCHA verification before you send this message.';
$txt['error_recapcha_post'] = 'You have not completed the reCAPTCHA verification.';
...
$txt['packageget_unable'] = 'Unable to connect to the server. Please try using <a href="%1$s" target="_blank" rel="noopener" class="new_win">this URL</a> instead.';
$txt['not_on_portamx'] = 'Sorry, packages can only be downloaded like this from the portamx.com server.';
...
$txt['json_unknown'] = 'Unknown JSON error';
?>