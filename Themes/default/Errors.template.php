...
function template_fatal_error()
{
	...
	<div id="fatal_error">
		...
		echo '
	<script>function GoBack(){document.location=document.referrer.length == 0 ? pmx_scripturl : (document.referrer.indexOf("signup") > 0 ? pmx_scripturl : document.referrer)}</script>
...
function template_error_log()
{
	...
	echo '
			...
			<div class="information">'. $txt['errlog_desc'] .'</div>
	...
	foreach ($context['errors'] as $error)
	{
		...
		echo '
							...
							<a style="display: table-cell; padding: 0; width: 20px; vertical-align: top;" href="', $scripturl, '?action=admin;area=logs;sa=errorlog', $context['sort_direction'] == 'down' ? ';desc' : '', ';filter=message;value=', $error['message']['href'], '" title="', $txt['apply_filter'], ': ', $txt['filter_only_message'], '"><span class="generic_icons filter"></span></a>
							<span style="display: table-cell;padding: 0 4px;">', $error['message']['html'], '</span>
						</div>
