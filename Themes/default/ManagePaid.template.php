...
function template_modify_subscription()
{
	...
	echo '
			<div class="windowbg'. (empty($context['disable_groups']) ? ' totop' : '') .'" style="margin-bottom:7px;">
				<dl class="settings">
					<dt>
						', $txt['paid_mod_name'], ':
					</dt>
...
function template_modify_user_subscription()
{
	...
	for ($month = 1; $month <= 12; $month++)
		echo '
						<option value="', $month, '"', $month == $context['sub']['start']['month'] ? ' selected' : '', '>', $txt['months_titles'][$month], '</option>';
	...
	for ($month = 1; $month <= 12; $month++)
		echo '
						<option value="', $month, '"', $month == $context['sub']['end']['month'] ? ' selected' : '', '>', $txt['months_titles'][$month], '</option>';
