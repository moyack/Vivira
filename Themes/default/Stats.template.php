		...
		foreach ($context['yearly'] as $id => $year)
		{
			...
			foreach ($year['months'] as $month)
			{
				...
				if ($month['expanded'])
				{
					...
					{
						echo '
				<tr class="windowbg" id="tr_day_', sprintf($modSettings['stats_format'], $day['year'],  $day['month'],  $day['day']), '">
					<td class="stats_day">', sprintf($modSettings['stats_format'], $day['year'], $day['month'], $day['day']), '</td>
