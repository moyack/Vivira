...
function template_search_members()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=viewmembers" method="post" accept-charset="', $context['character_set'], '" id="admin_form_wrapper">
				...
				<div class="flow_hidden">
					<div class="msearch_details floatleft">
						<dl class="settings right">
							...
							<dd>
								<input type="date" name="reg_date" id="reg_date" value="" size="10" class="input_text">
							</dd>
							<dt class="righttext">
							...
							<dd>
								<input type="date" name="last_online" id="last_online" value="" size="10" class="input_text">
							</dd>
						</dl>
					</div>
					...
					<div class="msearch_details floatright">
						<fieldset>
							<legend>', $txt['activation_status'], '</legend>
								...
								<label for="activated-11"><input type="checkbox" name="activated[]" value="11" id="activated-11" checked="checked" class="input_check" /> ', $txt['is_banned'], '</label>';

			if(isset($modSettings['gdpr_enabled']) && !empty($modSettings['gdpr_enabled']))
				echo '
								<br>
								<label for="gdpraccepted-1"><input type="checkbox" name="gdpraccepted[]" value="'. strval(strtotime($modSettings['gdpr_last_update']) + 43200) .'" id="gdpraccepted" checked="checked" class="input_check" /> ', $txt['gdpr_accept'], '</label>&nbsp;&nbsp;
								<label for="gdpraccepted-0"><input type="checkbox" name="gdpraccepted[]" value="0" id="gdpraccepted" checked="checked" class="input_check" /> ', $txt['no_gdpr_accept'], '</label>';
			...
			<input type="submit" value="', $txt['search'], '" class="button_submit addbuttspc">
		</form>
	</div>';
}
