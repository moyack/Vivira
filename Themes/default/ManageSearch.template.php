...
function template_show_spider_logs()
{
	...
	echo '
		<br class="clear">
		<form class="id="admin_form_wrapper" action="', $scripturl, '?action=admin;area=sengines;sa=logs" method="post" accept-charset="', $context['character_set'], '">
			<div class="cat_bar generic_list_wrapper">
