...
function template_reported_posts_block()
{
	...
	echo '
		...
		<div class="windowbg totop" id="reported_posts_panel">
			<div class="modbox">
				<ul>';
...
function template_viewmodreport()
{
	...
	echo '
					...
					<div class="modinp_div"><textarea class="modinp_box" rows="2" cols="60" name="mod_comment"></textarea></div>
					<div class="padding">
...
function template_edit_comment()
{
	...
	echo '
				<div class="modinp_div"><textarea class="modinp_box" rows="6" cols="60" name="mod_comment">', $context['comment']['body'] ,'</textarea></div>
				<div>
...
function template_viewmemberreport()
{
	...
	echo '
					...
					<div class="modinp_div"><textarea class="modinp_box" rows="2" cols="60" name="mod_comment"></textarea></div>
					<div class="padding" style="height:8px;">
						<input type="submit" name="add_comment" value="', $txt['mc_modreport_add_mod_comment'], '" class="button_submit">
						<input type="hidden" name="', $context['mod-reportC-add_token_var'], '" value="', $context['mod-reportC-add_token'], '">
					</div>
				</div>
