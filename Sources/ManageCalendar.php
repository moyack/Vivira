			...
			'date' => array(
				...
				'data' => array(
					'function' => function ($rowData) use ($txt)
					{
						...
						// Construct the date.
						return sprintf('%1$d %2$s %3$s', $rowData['day'], $txt['months_titles'][(int) $rowData['month']], $year);
					},
				),
				'sort' => array(
					'default' => 'event_date',
...
function EditHoliday()
{
	...
	// Submitting?
	if (isset($_POST[$context['session_var']]) && (isset($_REQUEST['delete']) || (isset($_REQUEST['title']) && $_REQUEST['title'] != '')))
	{
		checkSession();
