...
function Login()
{
	...
	if (isset($_SERVER['HTTP_REFERER']) && empty($_SESSION['login_url']))
		$_SESSION['login_url'] = $_SERVER['HTTP_REFERER'];

    $_SESSION['login_sess'] = $_SESSION['session_var'];
...
function Login2()
{
	...
	elseif (isset($_GET['sa']) && $_GET['sa'] == 'check')
	{
		...
		elseif (strpos($_SESSION['login_url'], 'http://') !== false || strpos($_SESSION['login_url'], 'https://') !== false)
		{
	...
	if (isset($_SERVER['HTTP_REFERER']) && empty($_SESSION['login_url']) && strpos('dlattach', $_SERVER['HTTP_REFERER']) === false)
		$_SESSION['login_url'] = $_SERVER['HTTP_REFERER'];
