...
function PackageBrowse()
{
	...
	$context['modification_types'] = array('modification', 'avatar', 'language', 'theme', 'unknown');
...
function list_getPackages($start, $items_per_page, $sort, $params)
{
	...
	if (isset($_GET['version_emulate']) && strtolower($_GET['version_emulate']) == $the_version)
		unset($_SESSION['version_emulate']);

	elseif (isset($_GET['version_emulate']))
	{
		if ($_GET['version_emulate'] === 0 || $_GET['version_emulate'] === strtr($forum_version, array('PortaMx-Forum' => 'PMX')) && isset($_SESSION['version_emulate']))
			unset($_SESSION['version_emulate']);
	...
	{
		$context['forum_version'] = 'PortaMx-Forum ' . strtr($_SESSION['version_emulate'], array('pmx ' => ''));
