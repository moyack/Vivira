	...
	*/
	$permissionList = array(
		...
		'board' => array(
			...
			'download_attach_file' => array(false, 'attachment'),
			'download_attach_image' => array(false, 'attachment')
		),
	);
			...
			foreach ($bothGroups as $group)
				if (!isset($context['permissions'][$permissionType]['columns'][$position][$group]))
					$context['permissions'][$permissionType]['columns'][$position][$group] = array(
						...
						'icon' => isset($txt['permissionicon_' . $group]) ? $txt['permissionicon_' . $group] : (isset($txt['permissionicon']) ? $txt['permissionicon'] : ''),
