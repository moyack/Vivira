...
class GroupAct_Notify_Background extends PMX_BackgroundTask
{
	...
	{
		global $sourcedir, $pmxcFunc, $language, $context, $user_info, $modSettings;
		...
		$reqList = array();
		foreach($this->_details['request_list'] as $k => $v)
			$reqList[intval($k)] = intval($v);
		...
		while ($row = $pmxcFunc['db_fetch_assoc']($request))
		{
			...
			$row['lngfile'] = empty($row['lngfile']) ? $language : $row['lngfile'];
