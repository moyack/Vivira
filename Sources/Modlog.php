	...
	$listOptions = array(
		...
		'columns' => array(
			...
			'ip' => array(
				'header' => array(
					'value' => $txt['modlog_ip'],
					'class' => 'lefttext log_ip_addr',
				),
				'data' => array(
					'db' => 'ip',
					'class' => 'smalltext log_ip_addr',
				),
				'sort' => array(
					'default' => 'lm.ip',
					'reverse' => 'lm.ip DESC',
		...
		'title' => (getREQcnt('adminlog') > 0
			? '<a href="'. $scripturl .'?action=helpadmin;help=adminlog" onclick="return reqOverlayDiv(this.href);" class="help"><span class="generic_icons help" title="Hilfe"></span></a>&nbsp;'. $txt['admin_log']
			: '<a href="'. $scripturl .'?action=helpadmin;help=modlog" onclick="return reqOverlayDiv(this.href);" class="help"><span class="generic_icons help" title="Hilfe"></span></a>&nbsp;'. $txt['moderation_log']),
		'additional_rows' => array(
			array(
				'position' => 'after_title',
				'value' => (getREQcnt('adminlog') > 0 ? $txt['admin_log_desc'] : $txt['moderation_log_desc']),
				'style' => 'float:left',
			),
			array(
				'position' => 'below_table_data',
				'value' => '
					<span style="text-align:right;display:inherit;">' . $txt['modlog_search'] . ' (' . $txt['modlog_by'] . ': ' . $context['search']['label'] . '):</span>
