...
{
	global $txt, $context, $modSettings, $pmxCacheFunc;
	...
	if (!empty($_POST['save_reserved_names']))
	{
		...
		updateSettings(array(
			...
			'write_tolog' => (isset($_POST['write_tolog']) ? '1' : '0'),
			'reserveNames' => str_replace("\r", '', $_POST['reserved'])
		));
		$pmxCacheFunc['put']('modSettings', null);
	...
	$context['reserved_word_options']['write_tolog'] = isset($modSettings['write_tolog']) && $modSettings['write_tolog'] == '1';
